...
class Api
{
    ...
    {
        if (Config::get('api_config.api_cross')) {
            //是否开启跨域
...
//        }
     ...
     */
    protected function success($msg = '请求成功', $data = null, $code = 1, $type = null, array $header = [])
    {
     ...
     * @param array $header 发送的 Header 信息
     */
    protected function error($msg = '请求异常', $data = null, $code = 0, $type = null, array $header = [])
    {
        $this->result($msg, $data, $code, $type, $header);
    }
